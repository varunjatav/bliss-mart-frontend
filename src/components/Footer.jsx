...
const Footer = () => {
  return (
    <footer className="container flex flex-col md:flex-row align-bottom justify-center gap-5 px-10 py-24">
      ...
      <section className="flex-1">
        ...
        <p>
          ...
          <a href="mailto:mohit.mohit979@gamil.com">mohit.mohit979@gamil.com</a>{" "}
        </p>
        <p>
          <span className="font-semibold">Mob:</span>{" "}
          <a href="what:+916392859129">6392859129</a>{" "}
        </p>
        <p>
